export function loadBeforeGame(){
	...
	header.className = "w-full grid grid-cols-[1fr_1.5fr_1fr] items-center py-6";
	...
	app.appendChild(header);
		...
		main.className = "flex flex-1 box-border overflow-hidden";

			const leftAside = document.createElement("aside");
			leftAside.className = "w-48 flex flex-col items-center gap-6 p-6 box-border";
		...
		const rightAside = document.createElement("aside");
			rightAside.className = "w-48 flex flex-col items-center gap-6 p-6 box-border";
	...
	// Falta criar aqui uma ultima div que vai ter os dois logotipos do projecto um na esquerda e outra na direita e depois o timer na div do meio
		const gameControls = document.createElement("div");
		gameControls.className = "absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-12 bg-black/40 backdrop-blur-md px-8 py-4 rounded-2xl border border-white/20 shadow-lg";
			...
			timer.className = "text-center";
				...
				time.className = "text-4xl font-bold";
